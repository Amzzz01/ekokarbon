    ...
    <AdminGuard>
      <AdminLayout>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
          <span style={{ fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: 20, color: '#1a3a2a' }}>Senarai Quiz</span>
        ...
        {showForm && (
          <div style={{ background: '#fff', border: '1px solid rgba(45,106,79,0.1)', borderRadius: 12, padding: 24, marginBottom: 24 }}>
            <h3 style={{ fontFamily: 'Syne, sans-serif', fontSize: 16, color: '#1a3a2a', marginBottom: 16 }}>{editId ? 'Edit Soalan' : 'Tambah Soalan Baru'}</h3>
